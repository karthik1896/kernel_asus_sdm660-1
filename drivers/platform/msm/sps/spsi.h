...
#else
#define	SPS_DBG3(dev, msg, args...)	pr_info(msg, ##args)
#define	SPS_DBG2(dev, msg, args...)	pr_info(msg, ##args)
#define	SPS_DBG1(dev, msg, args...)	pr_info(msg, ##args)
#define	SPS_DBG(dev, msg, args...)	pr_info(msg, ##args)
